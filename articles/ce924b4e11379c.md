...
また、今回使用したuseEffectを用いたfetchは[useSWR](https://swr.vercel.app/ja)や[Tansatck Query(React Query)](https://tanstack.com/query/v4/docs/adapters/react-query)でシンプルにできます。こちらもぜひ試してみて下さい。