...
先日エビスコムさまから[作って学ぶNext.js/React Webサイト構築](https://amzn.to/3PAjPdS)が発刊され、これであれば**普段Webコーディングを専門にされている方がJamstackに入門できる**と確信しました。
...
本記事では、図の内容を9ステップに分けてみました。初めての方でも負担が無いよう一つずつ積み上げながら進んでいきます。
